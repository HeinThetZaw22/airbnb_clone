...
const Navbar = () => {
  return (
    <div>
      <div className=" fixed container bg-white h-[80px] top-0 grid grid-cols-3 max-lg:grid-cols-2 items-center py-4">
        {/* logo  */}
        ...
        <div className="flex gap-2 max-lg:hidden tracking-tight heading">
          <div>Stays</div>
      ...
      {/* lg view  */}
      <div className="flex items-center font-montserrat pt-[80px] mb-5 py-1 justify-center lg:hidden gap-4 tracking-tight">
          <div>Stays</div>
